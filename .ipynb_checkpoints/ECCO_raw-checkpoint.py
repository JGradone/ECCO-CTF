...
with ProgressBar():
    ds2.sel(time_snp=slice('2017-01-01','2017-12-31')).to_netcdf('/Users/joegradone/SynologyDrive/Drive/Rutgers/Research/data/ECCO/Evaluated_Budgets/eccov4r4_budg_heat_salt_2005_2017_raw/eccov4r4_budg_heat_salt_2017.nc')
